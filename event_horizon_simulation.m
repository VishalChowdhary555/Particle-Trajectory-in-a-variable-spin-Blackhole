function event_horizon_simulation()
    ...
    title('Particle Trajectory near a Non-Rotating Black Hole with Event Horizon');
    xlabel('X');
    ylabel('Y');
    zlabel('Z');
    grid on;
...
function dydt = event_horizon_equations(t, y, G, M, a)
    r = y(1);
    theta = y(2);
    phi = y(3);
    v_r = y(4);
    ...
    dydt(4) = -G * M / r^2;
    dydt(5) = 0; % No angular velocity for simplicity
end
